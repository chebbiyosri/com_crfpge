<tr id="membreRow<?php echo $this->membre->membre_id; ?>">
  ...
  <td>
  <a href="<?php echo JRoute::_('index.php?option=com_crfpge&view=membre&layout=membre&membre_id='.$this->membre->membre_id); ?>" title="Détails" class="btn"> <i class="icon icon-info"></i> <?php echo JText::_('COM_CRFPGE_VIEW_DETAILS'); ?></a>
