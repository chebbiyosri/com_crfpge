<tr id="institutionRow<?php echo $this->institution->institution_id; ?>">
  ...
  <td>
  <a href="<?php echo JRoute::_('index.php?option=com_crfpge&view=institution&layout=institution&institution_id='.$this->institution->institution_id); ?>" title="Détails" class="btn"> <i class="icon icon-info"></i> <?php echo JText::_('COM_CRFPGE_VIEW_DETAILS'); ?></a>
