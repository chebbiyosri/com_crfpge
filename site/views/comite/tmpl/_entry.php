<tr id="comiteRow<?php echo $this->comite->comite_id; ?>">
  ...
  <td>
  <a href="<?php echo JRoute::_('index.php?option=com_crfpge&view=comite&layout=comite&comite_id='.$this->comite->comite_id); ?>" title="Détails" class="btn"> <i class="icon icon-info"></i> <?php echo JText::_('COM_CRFPGE_VIEW_DETAILS'); ?></a>
