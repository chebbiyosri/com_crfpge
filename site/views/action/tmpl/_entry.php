<tr id="actionRow<?php echo $this->action->action_id; ?>">
  ...
  <td>
  <a href="<?php echo JRoute::_('index.php?option=com_crfpge&view=action&layout=action&action_id='.$this->action->action_id); ?>" title="Détails" class="btn"> <i class="icon icon-info"></i> <?php echo JText::_('COM_CRFPGE_VIEW_DETAILS'); ?></a>
